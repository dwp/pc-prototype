  ...
  if (typeOfClaim == 'eligibility') {
    ...
    res.redirect(`${baseUrl}/bau-exit-8`)
      ...
      res.redirect(`${baseUrl}/bau-exit-7`)
        ...
        }  else if (typeOfClaim == 'bau-exit-11') {
...
router.post(`${baseUrl}/bau-exit-1-router`, (req, res) => {
...
router.post(`${baseUrl}/bau-exit-2-router`, (req, res) => {
...
router.post(`${baseUrl}/bau-exit-10-router`, (req, res) => {
...
router.post(`${baseUrl}/bau-process-measure-1-router`, (req, res) => {
  ...
  if (processMeasure1 == 'Yes') {
    res.redirect(`${baseUrl}/bau-process-measure-2`)
  }  else if (processMeasure1 == 'No') {
