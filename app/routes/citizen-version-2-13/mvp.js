...
const baseUrl = '/citizen-version-2-13/mvp'
...
router.use(`${baseUrl}/abc.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/abc.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/letter-17-nov.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/letter-17-nov.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/letter-13-jan.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/letter-13-jan.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/letter-17-jan.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/letter-17-jan.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/letter-26-may.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/letter-26-may.pdf'))) // ../ back up a directory
// router.use(`${baseUrl}/letter-march-2023.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/letter-march-2023.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/anthony-howarth-letter-a.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/anthony-howarth-letter-a.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/anthony-howarth-letter-b.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/anthony-howarth-letter-b.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/brian-tack-letter-a.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/brian-tack-letter-a.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/brian-tack-letter-b.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/brian-tack-letter-b.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/razia-hasam-letter-a.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/razia-hasam-letter-a.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/razia-hasam-letter-b.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/razia-hasam-letter-b.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/freda-hyatt-letter-a.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/freda-hyatt-letter-a.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/freda-hyatt-letter-b.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/freda-hyatt-letter-b.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/mb-letter-a.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/mb-letter-a.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/mb-letter-b.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/mb-letter-b.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/letter_a.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/letter_a.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/letter_b.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/letter_b.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/janesmith-a.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/janesmith-a.pdf'))) // ../ back up a directory
router.use(`${baseUrl}/janesmith-b.pdf`, express.static(path.resolve('app/views/citizen-version-2-13/mvp/janesmith-b.pdf'))) // ../ back up a directory
...
router.post(`${baseUrl}/state-pension-status-router`, (req, res) => {
  ...
  if (statePensionStatus === 'Yes') {
    res.redirect(`${baseUrl}/oidv-phone-email-check`)
...
router.post(`${baseUrl}/oidv-phone-email-check-router`, (req, res) => {
  const statePensionStatus = req.session.data['oidv-phone-email-check']

  if (statePensionStatus === 'Yes') {
    res.redirect(`${baseUrl}/oidv-filter`)
  } else if (statePensionStatus === 'No') {
...
router.post(`${baseUrl}/oidv-filter`, (req, res) => {
  // router.post('/oidv-filter', (req, res) => {
    const { data } = req.session
    // As long as they have picked at least 2 documents send them to OIDV
    if (data.haveDocuments?.length > 1) {
      return res.redirect('oidv-info')
    }
    return res.redirect('state-pension-payment-account')
  })
...
router.post(`${baseUrl}/doc-absence-medical-plural-bereaved-router`, (req, res) => {
  ...
  if (docAbsencePluralMedicalBereaved === 'Yes') {
    ...
    res.redirect(`${baseUrl}/doc-absence-dates-bereaved`)
  }
})
...
router.post(`${baseUrl}/doc-absence-plural-bereaved-router`, (req, res) => {
  ...
  if (docAbsencePluralBereaved === 'Yes') {
    res.redirect(`${baseUrl}/doc-absence-medical`)
  } else {
    res.redirect(`${baseUrl}/doc-absence-medical-bereaved`)
  }
})
...
router.post('/idv/hmrciv/idvselection', (req, res) => {
  ...
  if (passportConsent == 'true' && payslipOrP60 == 'payslip') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/your-passport-details-consent?payslip=true')
  }
  // Passport and P60 
  else if (passportConsent == 'true' && payslipOrP60 == 'p60') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/your-passport-details-consent?p60=true')
  }
  // Passport and Self Assessment 
  else if (passportConsent == 'true' && selfAssessment == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/your-passport-details-consent?sa=true')
  }
  // Passport and tax credits KBV
  else if (passportConsent == 'true' && voiceID == 'voiceIdNo') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/your-passport-details-consent?tcKbv=true')
  }
  // Passport and tax credits voice ID
  else if (passportConsent == 'true' && voiceID == 'voiceIdYes') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/your-passport-details-consent?voiceId=true')
  }
  // Passport and Transunion
  else if (passportConsent == 'true' && tuConsent == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/your-passport-details-consent?tuKbv=true')
  }

  // Payslip and tax credits KBV
  else if (payslipOrP60 == 'payslip' && voiceID == 'voiceIdNo') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/payslip-question-1?tcKbv=true');
  }
  // Payslip and Self Assessment 
  else if (payslipOrP60 == 'payslip' && selfAssessment == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/payslip-question-1?sa=true')
  }
  // Payslip and tax credits voice ID
  else if (payslipOrP60 == 'payslip' && voiceID == 'voiceIdYes') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/payslip-question-1?voiceId=true')
  }
  // Payslip and Transunion
  else if (payslipOrP60 == 'payslip' && tuConsent == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/payslip-question-1?tuKbv=true');
  }

  // P60 and Self Assessment 
  else if (payslipOrP60 == 'p60' && selfAssessment == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/p60-question-1?sa=true')
  }
  // P60 and tax credits KBV
  else if (payslipOrP60 == 'p60' && voiceID == 'voiceIdNo') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/p60-question-1?tcKbv=true');
  }
  // P60 and tax credits voice ID
  else if (payslipOrP60 == 'p60' && voiceID == 'voiceIdYes') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/p60-question-1?voiceId=true')
  }
  // P60 and Transunion
  else if (payslipOrP60 == 'p60' && tuConsent == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/p60-question-1?tuKbv=true');
  }

  // Self Assessment and tax credits KBV
  else if (selfAssessment == 'true' && voiceID == 'voiceIdNo') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/sa-questions?tcKbv=true');
  }
  // Self Assessment and tax credits voice ID
  else if (selfAssessment == 'true' && voiceID == 'voiceIdYes') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv//sa-questions?voiceId=true')
  }
  // Self Assessment and Transunion
  else if (selfAssessment == 'true' && tuConsent == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/sa-questions?tuKbv=true');
  }

  // Tax credits KBV and Transunion
  else if (voiceID == 'voiceIdNo' && tuConsent == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/tax-credits-question-1?tuKbv=true');
  }
  // Tax credits voice ID and Transunion
  else if (voiceID == 'voiceIdYes' && tuConsent == 'true') {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/voice-id?tuKbv=true')
  }
  // Fallback
  else {
    res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/choose-2-items-error')
  }
})

router.post('/citizen-version-2-13/mvp/idv/hmrciv/payslip', (req, res) => {
  res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/payslip-question-1');
})

router.post('/citizen-version-2-13/mvp/idv/hmrciv/p60', (req, res) => {
  res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/p60-question-1');
})

router.post('/citizen-version-2-13/mvp/idv/hmrciv/tcKbv', (req, res) => {
  res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/tax-credits-question-1');
})

router.post('/citizen-version-2-13/mvp/idv/hmrciv/tuKbv', (req, res) => {
  res.redirect('/citizen-version-2-13/mvp/idv/hmrciv/credit-record-questions-consent');
})

router.post('/citizen-version-2-13/mvp/idv/hmrciv/voiceId', (req, res) => {
  res.redirect("/citizen-version-2-13/mvp/idv/hmrciv/voice-id");
})
