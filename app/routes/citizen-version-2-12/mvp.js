...
const baseUrl = '/citizen-version-2-12/mvp'
...
router.use(`${baseUrl}/letter-26-may.pdf`, express.static(path.resolve('app/views/citizen-version-2-12/mvp/letter-26-may.pdf'))) // ../ back up a directory
// router.use(`${baseUrl}/letter-march-2023.pdf`, express.static(path.resolve('app/views/citizen-version-2-12/mvp/letter-march-2023.pdf'))) // ../ back up a directory
