...
const baseUrl = '/agent-service-1-16/agent'
...
router.post(`${baseUrl}/process-c-nil-task-4-2-1-router`, (req, res) => {
  const processTask_3_1 = req.session.data['process-c-nil-task-4-2-1']

  if (processTask_3_1 == 'Matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-3-1`)
  }
  else if (processTask_3_1 == 'Not matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-3-1`)
  }
...
router.post(`${baseUrl}/process-c-nil-task-4-3-1-router`, (req, res) => {
  const processTask_3_1 = req.session.data['process-c-nil-task-4-3-1']

  if (processTask_3_1 == 'Matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-4-1`)
  }
  else if (processTask_3_1 == 'Not matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-4-1`)
  }
...
router.post(`${baseUrl}/process-c-nil-task-4-4-1-router`, (req, res) => {
  const processTask_3_1 = req.session.data['process-c-nil-task-4-4-1']

  if (processTask_3_1 == 'Matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-4-2`)
  }
  else if (processTask_3_1 == 'Not matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-4-2`)
  }
...
router.post(`${baseUrl}/process-c-nil-task-4-4-2-router`, (req, res) => {
  const processTask_3_1 = req.session.data['process-c-nil-task-4-4-2']

  if (processTask_3_1 == 'Matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-4-3`)
  }
  else if (processTask_3_1 == 'Not matched') {
    res.redirect(`${baseUrl}/process-c-nil-task-4-4-3`)
  }
...
router.post(`${baseUrl}/process-c-nil-task-4-4-3-router`, (req, res) => {
  const processTask_3_1 = req.session.data['process-c-nil-task-4-4-3']
...
/* Mark K's addition for HMRC Scenario 3 */
router.get(`${baseUrl}/start`, (req, res) => {

  // This sets up the done tags on the task list
  req.session.data['process-c-nil-task-1-1'] = "Matched";
  req.session.data['process-c-nil-task-1-3'] = "Matched";
  req.session.data['process-c-nil-task-1-4'] = "Matched";
  req.session.data['process-c-nil-task-1-6'] = "Matched";
  req.session.data['process-c-nil-task-2-4'] = "Matched";;
  req.session.data['process-c-nil-task-2-1'] = "Matched";
  req.session.data['process-c-nil-task-2-2'] = "Matched";
  req.session.data['process-c-nil-task-2-3'] = "Matched";
  req.session.data['process-c-nil-task-3-1'] = "Matched";
  req.session.data['process-c-nil-task-3-9'] = "Matched";
  req.session.data['process-c-nil-task-3-13'] = "Matched";

  //this creates the data for scenario 3
...
router.post(`${baseUrl}/process-c-nil-task-4-4-1`, (req, res) => {
  if(req.session.data['scenario3-pension-complete']=="yes"){
    req.session.data['process-c-nil-task-4-4-1'] = "Matched";
    res.redirect(`${baseUrl}/process-c-nil-task-list`)
  }
  else if(req.session.data['scenario3-pension-complete']=="no"){
    res.redirect(`${baseUrl}/process-c-nil-task-4-4-2`)
  }
})

router.post(`${baseUrl}/process-c-nil-task-4-4-2`, (req, res) => {
  var count = 0;
  var average = 0;
